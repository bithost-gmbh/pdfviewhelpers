...
document wide headers and overwrite them on page level if desired.
Please see :ref:`the ViewHelper documentation <viewhelpers-header-footer>` as well as the :ref:`example of header and footer usage <headerandfooter>`.
