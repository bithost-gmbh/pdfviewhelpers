...
::
	...
	<html xmlns="http://www.w3.org/1999/xhtml"
		  ...
		  xsi:schemaLocation="http://typo3.org/ns/Bithost/Pdfviewhelpers/ViewHelpers https://pdfviewhelpers.bithost.ch/schema/4.0.xsd"
		  data-namespace-typo3-fluid="true">

	<pdf:document outputPath="overwritten_name.pdf" title="Full Feature Show Case">

		<pdf:header>
			<pdf:text type="header">Bithost GmbH - Milchbuckstrasse 83, 8057 Zürich</pdf:text>
		...
		<pdf:page>
			...
			<pdf:text lineHeight="0.5" characterSpacing="-0.5">
				This text has reduced lineHeight as well as reduced characterSpacing.
			</pdf:text>
